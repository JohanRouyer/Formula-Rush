const data = {
  products: [
    ...
    {
      name: 'Scuderia Ferrari Classic T-shirt',
    ...
    {
      name: 'Aston martin F1 Team shirt',
      slug: 'aston-martin-f1-team-shirt',
      category: 'shirt',
      image: '/images/aston-tshirt.png',
      price: 49.99,
      countInStock: 14,
      brand: 'aston martin',
      rating: 4.5,
      numReviews: 9,
      description:
        'Comfortable shirt with Aston Martin F1 Team graphics and warm lining.',
    },
  ],
};
export default data;
